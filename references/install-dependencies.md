...
**验收**:
```bash
python3 scripts/generate_mechanism.py --help
...
echo ""
echo "=== mechanigraph ==="
python3 scripts/generate_mechanism.py --help >/dev/null 2>&1 && echo "generate_mechanism OK"
test -f SKILL.md && echo "mechanigraph/SKILL.md OK"
echo "=== DONE ==="
```
