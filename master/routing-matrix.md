...
| 学术机制图、理论机制图、分析框架图、演进模型、政策网络、治理体系、纯矢量SVG、机制图复刻、机制图生成、因果图绘制（兼容 mechanismgraph / mechanigraph 拼写） | mechanigraph | `SKILL.md`（出图前 ask_user 确认风格偏好，出图后无头 Chrome 渲染自检） |
